...
```{r}
# Fit model allowing different variances per entry
# Attempts heterogeneous variance (different variance per entry)
# May not converge if variances are similar across groups

#rank_model_hetero <- gls(r ~ Entry, 
#                          data = data_sorted,
#                         weights = varIdent(form = ~ 1 | Entry))

# Note the false convergence error
```
